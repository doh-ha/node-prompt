...
export const StyleNode: React.FC<StyleNodeProps> = ({ data, selected, id }) => {
  ...
  return (
    <ContextNodeContainer>
      ...
      <RecommendationPanel currentPrompt={currentPrompt} nodeType="style" onSelectRecommendation={handleSelectRecommendation} isVisible={showRecommendations} onClose={handleCloseRecommendations} />
    </ContextNodeContainer>
  );
};
